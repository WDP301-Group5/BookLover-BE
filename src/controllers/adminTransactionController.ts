...
export const getTransactions = async (req: Request, res: Response) => {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Không thể lấy danh sách giao dịch";
...
export const updateStatus = async (req: Request, res: Response) => {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Không thể cập nhật trạng thái giao dịch";
...
export const getRevenueReport = async (req: Request, res: Response) => {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Không thể lấy báo cáo doanh thu";
